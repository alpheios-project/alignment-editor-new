...
class Embedded {
  ...
  constructor ({
    ...
    this.app = components.AppController.create(this.state, {
      ...
      app: { version:`${packageVersion}`, buildBranch: "dev", buildNumber: "20210214469", buildName: "dev.20210214469", name: packageDescription },
...
/******/ 	return __webpack_require__("./embedded.js");
/******/ })()
;
